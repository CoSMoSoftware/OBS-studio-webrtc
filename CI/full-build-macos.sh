...
install_libwebrtc() {
    ...
    ensure_dir ${DEPS_BUILD_DIR}
    step "Download..."
    ${CURLCMD} --progress-bar -u ${FTP_LOGIN}:${FTP_PASSWORD} -L -C - -o libWebRTC.dmg ${FTP_PATH_PREFIX}/mac/libWebRTC-${1}-x64-Release-Community.dmg
    ...
    step "Copy to destination..."
    cp -r /Volumes/libWebRTC-${1}-x64-Release-Community/libwebrtc ./
}
