...
if exist libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-H264-OpenSSL_1_1_1n.exe (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH_PREFIX%/windows/libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-H264-OpenSSL_1_1_1n.exe -f --retry 5 -z libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-H264-OpenSSL_1_1_1n.exe) else (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH_PREFIX%/windows/libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-H264-OpenSSL_1_1_1n.exe -f --retry 5 -C -)
...
libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-H264-OpenSSL_1_1_1n.exe /S /SD /D="%CD%\libwebrtc"
