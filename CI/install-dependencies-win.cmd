...
if exist libWebRTC-84.0-x64-Release-H264.exe (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH% -f --retry 5 -z libWebRTC-84.0-x64-Release-H264.exe) else (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH% -f --retry 5 -C -)
...
dir
libWebRTC-84.0-x64-Release-H264.exe /S /SD /D="%CD%\libwebrtc"
