...
if exist libWebRTC-84.0-x64-Release-H264.exe (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO ftp://ftpperso.free.fr/libwebrtc/linux/libWebRTC-84.0-x64-Release-H264.exe -f --retry 5 -z libWebRTC-%LIBWEBRTC_VERSION%-x64-RelComm.exe) else (curl -kLO https://www.palakis.fr/obs/obs-studio-webrtc/libWebRTC-%LIBWEBRTC_VERSION%-x64-RelComm.exe -f --retry 5 -C -)
