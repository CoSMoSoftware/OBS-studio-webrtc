...
if exist libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-Community.exe (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH_PREFIX%/windows/libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-Community.exe -f --retry 5 -z libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-Community.exe) else (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH_PREFIX%/windows/libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-Community.exe -f --retry 5 -C -)
...
libWebRTC-%LIBWEBRTC_VERSION%-x64-Release-Community.exe /S /SD /D="%CD%\libwebrtc"
