...
if exist libWebRTC-84.0-x64-Release-H264.exe (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH% -f --retry 5 -z libWebRTC-%LIBWEBRTC_VERSION%-x64-RelComm.exe) else (curl -u %FTP_LOGIN%:%FTP_PASSWORD% -kLO %FTP_PATH% -f --retry 5 -C -)
