...
#mv ./rundir/RELEASE/obs-plugins/CEF.app ./
...
# mv ./rundir/RELEASE/data/obs-scripting/_obspython.so ./rundir/RELEASE/bin/
# mv ./rundir/RELEASE/data/obs-scripting/obspython.py ./rundir/RELEASE/bin/
...
#hr "Moving CEF back"
#mv ./CEF.app ./rundir/RELEASE/obs-plugins/
