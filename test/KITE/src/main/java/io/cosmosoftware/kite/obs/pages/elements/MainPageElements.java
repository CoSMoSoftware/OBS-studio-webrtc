...
public class MainPageElements extends PageElements {
  ...
  // WINDOWS============================================================
  private String buttonWIN = "/Window/Window[1]/Custom/Button";
  private String addSourceButton = "/Window/Window[5]/Custom/Custom/ToolBar/Button[@Name='Add']";
  private String startStreamBtnWIN = "/Window/Window[1]/Custom/Button[1]";//
  private String settingButtonWIN = "/Window/Window[1]/Custom/Button[4]";//
  ...
  private String exitBtnWIN = "/Window/Window[1]/Custom/Button[5]"; //

  // MAC================================================================
  private String buttonMAC = "/AXApplication/AXWindow/AXButton";
  private String startStreamBtnMAC = "/AXApplication/AXWindow/AXButton[16]";//
  private String settingButtonMAC = "/AXApplication/AXWindow/AXButton[19]";//
  private String statusTextMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXStaticText[2]";//
  private String dropFrameStatusMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXStaticText[1]";
  private String liveStatusMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXStaticText[2]";
  private String cpuStatusMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXStaticText[3]";
  private String recStatusMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXStaticText[4]";
  private String getStatsMAC = "/AXApplication/AXWindow/AXStaticText[1]/AXTextArea[0]";
  private String exitBtnMAC = "/AXApplication/AXWindow/AXButton[20]";
