...
function(setup_binary_target target)
  string(REPLACE "-" "_" target_without_dash "${target}")
  # Set up installation paths for program install
  install(
    TARGETS ${target}
    RUNTIME DESTINATION ${OBS_EXECUTABLE_DESTINATION} COMPONENT ${target_without_dash}_Runtime
    ...
    ARCHIVE DESTINATION ${OBS_LIBRARY_DESTINATION} COMPONENT ${target_without_dash}_Development
    PUBLIC_HEADER
  ...
  add_custom_command(
    ...
    COMMAND "${CMAKE_COMMAND}" -E env DESTDIR= "${CMAKE_COMMAND}" --install .. --config $<CONFIG> --prefix
            ${OBS_OUTPUT_DIR}/$<CONFIG> --component obs_${target_without_dash} > "$<IF:$<PLATFORM_ID:Windows>,nul,/dev/null>"
...
function(setup_plugin_target target)
  ...
  install(
    TARGETS ${target}
    RUNTIME DESTINATION ${OBS_PLUGIN_DESTINATION} COMPONENT ${target_without_dash}_Runtime
