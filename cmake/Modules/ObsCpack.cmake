...
if(INSTALLER_RUN)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc-${OBS_VERSION}-${GIT_TAG}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc-x64-${OBS_VERSION}-${GIT_TAG}")
else()
	if(WIN32)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc-x86-${OBS_VERSION}-${GIT_TAG}")
endif()
