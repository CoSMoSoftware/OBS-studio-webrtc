...
if(INSTALLER_RUN)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc$<$<BUILD_NDI:ON>-ndi>-${OBS_VERSION}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc$<$<BUILD_NDI:ON>-ndi>-x64-${OBS_VERSION}")
else()
	if(WIN32)
	...
	set(CPACK_PACKAGE_FILE_NAME "obs-webrtc$<$<BUILD_NDI:ON>-ndi>-x86-${OBS_VERSION}")
endif()
