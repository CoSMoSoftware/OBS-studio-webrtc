...
!ifdef INSTALL64
	...
	ExecWait "$TEMP\OBS\check_for_64bit_visual_studio_2019_runtimes.exe" $R0
	Delete "$TEMP\OBS\check_for_64bit_visual_studio_2019_runtimes.exe"
	RMDir "$TEMP\OBS"
...
!endif
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "Publisher" "Millicast"
