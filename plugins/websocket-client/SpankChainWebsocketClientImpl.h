...
class SpankChainWebsocketClientImpl : public WebsocketClient
{
public:
    SpankChainWebsocketClientImpl();
    ~SpankChainWebsocketClientImpl();
    virtual bool connect(const std::string& url, long long room, const std::string& apiURL, const std::string & token, Listener* listener) override;
