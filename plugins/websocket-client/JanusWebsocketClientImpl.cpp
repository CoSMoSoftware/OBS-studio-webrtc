...
bool JanusWebsocketClientImpl::connect(
        ...
        WebsocketClient::Listener * listener)
{
    ...
    std::string username = !raw_username.empty() ? sanitizeString(raw_username) : "";
    ...
    while (is_running.load()) {
        if (connection) {
            ...
            try {
                ...
                std::cout << "keepConnectionAlive exception: " << e.what() << std::endl;
            }
        }
...
void JanusWebsocketClientImpl::destroy()
{
    if (connection) {
        ...
        try {
            ...
            std::cout << "destroy exception: " << e.what() << std::endl;
        }
    }
}
