        ...
        WebsocketClient::Listener * listener)
{
    ...
    try {
        ...
        warn("WowzaWebsocketClientImpl::connect exception: %s", e.what());
        return false;
    }
    // OK
    return true;
...
bool WowzaWebsocketClientImpl::disconnect(bool wait)
{
    ...
    try {
        ...
        if (ec)
            warn("WowzaWebsocketClientImpl::disconnect close exception: %s", ec.message().c_str());
        client.stop();
        ...
        warn("WowzaWebsocketClientImpl::disconnect exception: %s", e.what());
        return false;
    }
    return true;
}
