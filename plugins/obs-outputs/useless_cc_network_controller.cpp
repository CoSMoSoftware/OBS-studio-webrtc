...
UselessCcNetworkController::OnNetworkAvailability(NetworkAvailability msg)
{
...
NetworkControlUpdate
UselessCcNetworkController::OnNetworkRouteChange(NetworkRouteChange msg)
{
	return NetworkControlUpdate();
}

NetworkControlUpdate
UselessCcNetworkController::OnProcessInterval(ProcessInterval msg)
{
	NetworkControlUpdate update;
...
NetworkControlUpdate
UselessCcNetworkController::OnRemoteBitrateReport(RemoteBitrateReport msg)
{
	return NetworkControlUpdate();
}

NetworkControlUpdate
UselessCcNetworkController::OnRoundTripTimeUpdate(RoundTripTimeUpdate msg)
{
...
NetworkControlUpdate
UselessCcNetworkController::OnSentPacket(SentPacket sent_packet)
{
	return NetworkControlUpdate();
}

NetworkControlUpdate
UselessCcNetworkController::OnReceivedPacket(ReceivedPacket received_packet)
{
	return NetworkControlUpdate();
}

NetworkControlUpdate
UselessCcNetworkController::OnStreamsConfig(StreamsConfig msg)
{
	NetworkControlUpdate update;
	return update;
}
...
NetworkControlUpdate
UselessCcNetworkController::OnTransportLossReport(TransportLossReport msg)
{
	return NetworkControlUpdate();
}
...
NetworkControlUpdate
UselessCcNetworkController::OnNetworkStateEstimate(NetworkStateEstimate msg)
{
	return NetworkControlUpdate();
}
