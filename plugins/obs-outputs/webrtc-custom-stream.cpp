...
extern "C" void webrtc_custom_receive_video(void *data, struct video_data *frame)
{
	//Get stream
	WebRTCStream *stream = (WebRTCStream*)data;
	//Process audio
...
extern "C" void webrtc_custom_receive_audio(void *data, struct audio_data *frame)
{
	//Get stream
	WebRTCStream *stream = (WebRTCStream*)data;
	//Process audio
...
extern "C" obs_properties_t *webrtc_custom_stream_properties(void *unused)
{
	...
	obs_properties_add_int(props, OPT_DROP_THRESHOLD,
			obs_module_text("webrtc_customStream.DropThreshold"),
			200, 10000, 100);
...
extern "C" {
    ...
    // NOTE LUDO: #80 add getStats
    webrtc_custom_stream_get_stats,
    webrtc_custom_stream_get_stats_list,
