...
obsWebrtcAudioSource::obsWebrtcAudioSource() { sink_ = nullptr; }

obsWebrtcAudioSource::~obsWebrtcAudioSource() { free(pending); }

void obsWebrtcAudioSource::Initialize(audio_t *audio, cricket::AudioOptions *options)
{
