...
public:
    ...
    static void stereoSDP(std::string &sdp, int audioBitrate)
    {
        ...
        if (testLine == -1) {
            ...
            if (fmtpLine != -1) {
                ...
                if (artpLine != -1) {
                    sdpLines.insert(sdpLines.begin() + artpLine + 1, "a=fmtp:111 minptime=10;useinbandfec=1");
                    sdpLines[artpLine+1] = sdpLines[artpLine+1].append(";stereo=1;sprop-stereo=1");
                    sdpLines[artpLine+1] = sdpLines[artpLine+1].append(";maxplaybackrate=48000;sprop-maxcapturerate=48000");
                    if (audioBitrate > 0) {
    ...
    static bool filterIceCandidates(
