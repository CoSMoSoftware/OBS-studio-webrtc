...
EXPORT void obs_property_button_group_item_disable(obs_property_t *p, size_t idx,
								bool disabled);
EXPORT bool obs_property_button_group_item_disabled(obs_property_t *p, size_t idx);

EXPORT void obs_property_button_group_item_remove(obs_property_t *p, size_t idx);
