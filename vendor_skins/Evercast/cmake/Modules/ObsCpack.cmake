...
if(INSTALLER_RUN)
  ...
  set(CPACK_PACKAGE_EXECUTABLES  "ebs${_output_suffix}" "EBS Studio")
...
if(INSTALLER_RUN)
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "EBSStudio")
  ...
  set(CPACK_PACKAGE_FILE_NAME "ebs-studio-${EBS_VERSION}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
  if(WIN32)
    set(CPACK_PACKAGE_NAME "EBS Studio (64bit)")
  endif()
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "EBSStudio64")
  ...
  set(CPACK_PACKAGE_FILE_NAME "ebs-studio-x64-${EBS_VERSION}")
else()
  if(WIN32)
    set(CPACK_PACKAGE_NAME "EBS Studio (32bit)")
  endif()
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "EBSStudio32")
  ...
  set(CPACK_PACKAGE_FILE_NAME "ebs-studio-x86-${EBS_VERSION}")
endif()
