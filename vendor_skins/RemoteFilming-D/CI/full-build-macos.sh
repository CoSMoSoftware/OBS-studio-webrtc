...
bundle_dylibs() {
    ...
    ${CI_SCRIPTS}/app/dylibbundler -cd -of -a ./D-CAM.app -q -f \
       ...
       -x ./D-CAM.app/Contents/PlugIns/aja.so \
       -x ./D-CAM.app/Contents/PlugIns/aja-output-ui.so \
...
#       -x ./D-CAM.app/Contents/PlugIns/obs-browser.so \
    ...
    /bin/cp ./libobs-opengl/${BUILD_CONFIG}/libobs-opengl.so ./D-CAM.app/Contents/Frameworks
}
...
prepare_macos_bundle() {
    ...
    /bin/cp -R dSYMs D-CAM.app/Contents/
...
#    /bin/cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Renderer).app" "./D-CAM.app/Contents/Frameworks/OBS Helper (Renderer).app"
    ...
    if [ -d ./D-CAM.app/Contents/Resources/data/obs-scripting ]; then
        ...
        # /bin/mv ./D-CAM.app/Contents/Resources/data/obs-scripting/obspython.py ./D-CAM.app/Contents/Resources/
    ...
    /bin/cp -cpR /tmp/obsdeps/lib/*.dylib ./D-CAM.app/Contents/Frameworks
