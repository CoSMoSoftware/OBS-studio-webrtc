...
configure_obs_build() {
    ...
    if [ -d ./RemoteFilming-D.app ]; then
        ...
        mv "../${BUILD_DIR}_${VENDOR}/RemoteFilming-D.app" .
...
#        -x ./RemoteFilming-D.app/Contents/PlugIns/obs-browser.so
    ...
    cp ./libobs-opengl/libobs-opengl.so ./RemoteFilming-D.app/Contents/Frameworks

    step "Copy QtNetwork for plugin support"
    cp -R /tmp/obsdeps/lib/QtNetwork.framework ./RemoteFilming-D.app/Contents/Frameworks
    chmod -R +w ./RemoteFilming-D.app/Contents/Frameworks/QtNetwork.framework
    rm -r ./RemoteFilming-D.app/Contents/Frameworks/QtNetwork.framework/Headers
    rm -r ./RemoteFilming-D.app/Contents/Frameworks/QtNetwork.framework/Versions/5/Headers/
    chmod 644 ./RemoteFilming-D.app/Contents/Frameworks/QtNetwork.framework/Versions/5/Resources/Info.plist
...
install_frameworks() {
    ...
    step "Copy Framework..."
    cp -R "${DEPS_BUILD_DIR}/cef_binary_${MACOS_CEF_BUILD_VERSION}_macosx64/Release/Chromium Embedded Framework.framework" ./RemoteFilming-D.app/Contents/Frameworks/
    chown -R $(whoami) ./RemoteFilming-D.app/Contents/Frameworks/
}
...
prepare_macos_bundle() {
    ...
    if [ -d ./RemoteFilming-D.app ]; then rm -rf ./RemoteFilming-D.app; fi

    hr "Preparing RemoteFilming-D.app bundle"
    step "Copy binary and plugins..."
    mkdir -p RemoteFilming-D.app/Contents/MacOS
    mkdir RemoteFilming-D.app/Contents/PlugIns
    mkdir RemoteFilming-D.app/Contents/Resources
    mkdir RemoteFilming-D.app/Contents/Frameworks

    cp rundir/${BUILD_CONFIG}/bin/rfs ./RemoteFilming-D.app/Contents/MacOS
    cp rundir/${BUILD_CONFIG}/bin/obs-ffmpeg-mux ./RemoteFilming-D.app/Contents/MacOS
    cp rundir/${BUILD_CONFIG}/bin/libobsglad.0.dylib ./RemoteFilming-D.app/Contents/MacOS
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper.app" "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper.app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (GPU).app" "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (GPU).app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Plugin).app" "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (Plugin).app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Renderer).app" "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (Renderer).app"
    cp -R rundir/${BUILD_CONFIG}/data ./RemoteFilming-D.app/Contents/Resources
    cp "${CI_SCRIPTS}/app/AppIcon.icns" ./RemoteFilming-D.app/Contents/Resources
    cp -R rundir/${BUILD_CONFIG}/obs-plugins/ ./RemoteFilming-D.app/Contents/PlugIns
    cp "${CI_SCRIPTS}/app/Info.plist" ./RemoteFilming-D.app/Contents
    ...
    if [ -d ./RemoteFilming-D.app/Contents/Resources/data/obs-scripting ]; then
        mv ./RemoteFilming-D.app/Contents/Resources/data/obs-scripting/obslua.so ./RemoteFilming-D.app/Contents/MacOS/
        # mv ./RemoteFilming-D.app/Contents/Resources/data/obs-scripting/_obspython.so ./RemoteFilming-D.app/Contents/MacOS/
        # mv ./RemoteFilming-D.app/Contents/Resources/data/obs-scripting/obspython.py ./RemoteFilming-D.app/Contents/MacOS/
        rm -rf ./RemoteFilming-D.app/Contents/Resources/data/obs-scripting/
    fi

    bundle_dylibs
#    install_frameworks

    cp "${CI_SCRIPTS}/app/OBSPublicDSAKey.pem" ./RemoteFilming-D.app/Contents/Resources

    step "Set bundle meta information..."
    plutil -insert CFBundleVersion -string "${OBS_VERSION}" ./RemoteFilming-D.app/Contents/Info.plist
    plutil -insert CFBundleShortVersionString -string "${MACOSX_BUNDLE_SHORT_VERSION_STRING}" ./RemoteFilming-D.app/Contents/Info.plist
    # plutil -insert OBSFeedsURL -string https://obsproject.com/osx_update/feeds.xml ./RemoteFilming-D.app/Contents/Info.plist
    # plutil -insert SUFeedURL -string https://obsproject.com/osx_update/stable/updates.xml ./RemoteFilming-D.app/Contents/Info.plist
    # plutil -insert SUPublicDSAKeyFile -string OBSPublicDSAKey.pem ./RemoteFilming-D.app/Contents/Info.plist
}
...
prepare_macos_image() {
    ...
    echo -n "${COLOR_ORANGE}"
    dmgbuild "RemoteFilming-D ${OBS_VERSION}" "${FILE_NAME}" -s ./settings.json
    echo -n "${COLOR_RESET}"
...
codesign_bundle() {
    ...
    xattr -crs ./RemoteFilming-D.app

    read_codesign_ident

    # step "Code-sign Sparkle framework..."
    # echo -n "${COLOR_ORANGE}"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Sparkle.framework/Versions/A/Resources/Autoupdate.app/Contents/MacOS/fileop"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Sparkle.framework/Versions/A/Resources/Autoupdate.app/Contents/MacOS/Autoupdate"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" --deep ./RemoteFilming-D.app/Contents/Frameworks/Sparkle.framework
    # echo -n "${COLOR_RESET}"

#    step "Code-sign CEF framework..."
#    echo -n "${COLOR_ORANGE}"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libEGL.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libswiftshader_libEGL.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libGLESv2.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libswiftshader_libGLESv2.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libvk_swiftshader.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-D.app/Contents/Frameworks/Chromium Embedded Framework.framework"
#    echo -n "${COLOR_RESET}"

#    step "Code-sign CEF helper apps..."
#    /bin/echo -n "${COLOR_ORANGE}"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper.app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-gpu-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (GPU).app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-plugin-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (Plugin).app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-renderer-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-D.app/Contents/Frameworks/OBS Helper (Renderer).app"
#    /bin/echo -n "${COLOR_RESET}"

    step "Code-sign OBS code..."
    echo -n "${COLOR_ORANGE}"
    codesign --force --timestamp --options runtime --deep --sign "${CODESIGN_IDENT}" "./RemoteFilming-D.app/Contents/Resources/data/obs-mac-virtualcam.plugin"
    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" --deep ./RemoteFilming-D.app
    echo -n "${COLOR_RESET}"
    step "Check code-sign result..."
    codesign -dvv ./RemoteFilming-D.app
}
