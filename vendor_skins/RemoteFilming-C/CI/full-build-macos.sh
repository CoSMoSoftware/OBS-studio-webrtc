...
configure_obs_build() {
    ...
    if [ -d ./RemoteFilming-C.app ]; then
        ...
        mv "../${BUILD_DIR}_${VENDOR}/RemoteFilming-C.app" .
...
#        -x ./RemoteFilming-C.app/Contents/PlugIns/obs-browser.so
    ...
    cp ./libobs-opengl/libobs-opengl.so ./RemoteFilming-C.app/Contents/Frameworks

    step "Copy QtNetwork for plugin support"
    cp -R /tmp/obsdeps/lib/QtNetwork.framework ./RemoteFilming-C.app/Contents/Frameworks
    chmod -R +w ./RemoteFilming-C.app/Contents/Frameworks/QtNetwork.framework
    rm -r ./RemoteFilming-C.app/Contents/Frameworks/QtNetwork.framework/Headers
    rm -r ./RemoteFilming-C.app/Contents/Frameworks/QtNetwork.framework/Versions/5/Headers/
    chmod 644 ./RemoteFilming-C.app/Contents/Frameworks/QtNetwork.framework/Versions/5/Resources/Info.plist
...
install_frameworks() {
    ...
    step "Copy Framework..."
    cp -R "${DEPS_BUILD_DIR}/cef_binary_${MACOS_CEF_BUILD_VERSION}_macosx64/Release/Chromium Embedded Framework.framework" ./RemoteFilming-C.app/Contents/Frameworks/
    chown -R $(whoami) ./RemoteFilming-C.app/Contents/Frameworks/
}
...
prepare_macos_bundle() {
    ...
    mkdir -p RemoteFilming-C.app/Contents/MacOS
    mkdir RemoteFilming-C.app/Contents/PlugIns
    mkdir RemoteFilming-C.app/Contents/Resources
    mkdir RemoteFilming-C.app/Contents/Frameworks

    cp rundir/${BUILD_CONFIG}/bin/rfs ./RemoteFilming-C.app/Contents/MacOS
    cp rundir/${BUILD_CONFIG}/bin/obs-ffmpeg-mux ./RemoteFilming-C.app/Contents/MacOS
    cp rundir/${BUILD_CONFIG}/bin/libobsglad.0.dylib ./RemoteFilming-C.app/Contents/MacOS
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper.app" "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper.app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (GPU).app" "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (GPU).app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Plugin).app" "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (Plugin).app"
#    cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Renderer).app" "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (Renderer).app"
    cp -R rundir/${BUILD_CONFIG}/data ./RemoteFilming-C.app/Contents/Resources
    cp "${CI_SCRIPTS}/app/AppIcon.icns" ./RemoteFilming-C.app/Contents/Resources
    cp -R rundir/${BUILD_CONFIG}/obs-plugins/ ./RemoteFilming-C.app/Contents/PlugIns
    cp "${CI_SCRIPTS}/app/Info.plist" ./RemoteFilming-C.app/Contents
    ...
    if [ -d ./RemoteFilming-C.app/Contents/Resources/data/obs-scripting ]; then
        mv ./RemoteFilming-C.app/Contents/Resources/data/obs-scripting/obslua.so ./RemoteFilming-C.app/Contents/MacOS/
        # mv ./RemoteFilming-C.app/Contents/Resources/data/obs-scripting/_obspython.so ./RemoteFilming-C.app/Contents/MacOS/
        # mv ./RemoteFilming-C.app/Contents/Resources/data/obs-scripting/obspython.py ./RemoteFilming-C.app/Contents/MacOS/
        rm -rf ./RemoteFilming-C.app/Contents/Resources/data/obs-scripting/
    fi

    bundle_dylibs
#    install_frameworks

    cp "${CI_SCRIPTS}/app/OBSPublicDSAKey.pem" ./RemoteFilming-C.app/Contents/Resources

    step "Set bundle meta information..."
    plutil -insert CFBundleVersion -string "${OBS_VERSION}" ./RemoteFilming-C.app/Contents/Info.plist
    plutil -insert CFBundleShortVersionString -string "${MACOSX_BUNDLE_SHORT_VERSION_STRING}" ./RemoteFilming-C.app/Contents/Info.plist
    # plutil -insert OBSFeedsURL -string https://obsproject.com/osx_update/feeds.xml ./RemoteFilming-C.app/Contents/Info.plist
    # plutil -insert SUFeedURL -string https://obsproject.com/osx_update/stable/updates.xml ./RemoteFilming-C.app/Contents/Info.plist
    # plutil -insert SUPublicDSAKeyFile -string OBSPublicDSAKey.pem ./RemoteFilming-C.app/Contents/Info.plist
}
...
codesign_bundle() {
    ...
    xattr -crs ./RemoteFilming-C.app

    read_codesign_ident

    # step "Code-sign Sparkle framework..."
    # echo -n "${COLOR_ORANGE}"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Sparkle.framework/Versions/A/Resources/Autoupdate.app/Contents/MacOS/fileop"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Sparkle.framework/Versions/A/Resources/Autoupdate.app/Contents/MacOS/Autoupdate"
    # codesign --force --options runtime --sign "${CODESIGN_IDENT}" --deep ./RemoteFilming-C.app/Contents/Frameworks/Sparkle.framework
    # echo -n "${COLOR_RESET}"

#    step "Code-sign CEF framework..."
#    echo -n "${COLOR_ORANGE}"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libEGL.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libswiftshader_libEGL.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libGLESv2.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libswiftshader_libGLESv2.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework/Libraries/libvk_swiftshader.dylib"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-C.app/Contents/Frameworks/Chromium Embedded Framework.framework"
#    echo -n "${COLOR_RESET}"

#    step "Code-sign CEF helper apps..."
#    /bin/echo -n "${COLOR_ORANGE}"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper.app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-gpu-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (GPU).app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-plugin-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (Plugin).app"
#    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/helpers/helper-renderer-entitlements.plist" --sign "${CODESIGN_IDENT}" --deep "./RemoteFilming-C.app/Contents/Frameworks/OBS Helper (Renderer).app"
#    /bin/echo -n "${COLOR_RESET}"

    step "Code-sign OBS code..."
    echo -n "${COLOR_ORANGE}"
    codesign --force --timestamp --options runtime --deep --sign "${CODESIGN_IDENT}" "./RemoteFilming-C.app/Contents/Resources/data/obs-mac-virtualcam.plugin"
    codesign --force --timestamp --options runtime --entitlements "${CI_SCRIPTS}/app/entitlements.plist" --sign "${CODESIGN_IDENT}" --deep ./RemoteFilming-C.app
    echo -n "${COLOR_RESET}"
    step "Check code-sign result..."
    codesign -dvv ./RemoteFilming-C.app
}
