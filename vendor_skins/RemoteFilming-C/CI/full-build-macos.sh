...
bundle_dylibs() {
    ...
    ${CI_SCRIPTS}/app/dylibbundler -cd -of -a ./C-CAM.app -q -f \
       ...
       -x ./C-CAM.app/Contents/PlugIns/aja.so \
       -x ./C-CAM.app/Contents/PlugIns/aja-output-ui.so \
...
#       -x ./C-CAM.app/Contents/PlugIns/obs-browser.so \
    ...
    /bin/cp ./libobs-opengl/${BUILD_CONFIG}/libobs-opengl.so ./C-CAM.app/Contents/Frameworks
}
...
prepare_macos_bundle() {
    ...
    /bin/cp -R dSYMs C-CAM.app/Contents/
...
#    /bin/cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Renderer).app" "./C-CAM.app/Contents/Frameworks/OBS Helper (Renderer).app"
    ...
    if [ -d ./C-CAM.app/Contents/Resources/data/obs-scripting ]; then
        ...
        # /bin/mv ./C-CAM.app/Contents/Resources/data/obs-scripting/obspython.py ./C-CAM.app/Contents/Resources/
    ...
    /bin/cp -cpR /tmp/obsdeps/lib/*.dylib ./C-CAM.app/Contents/Frameworks
