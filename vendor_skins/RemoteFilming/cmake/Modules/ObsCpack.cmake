...
set(CPACK_PACKAGE_NAME "RemoteFilmingStudio")
set(CPACK_PACKAGE_VENDOR "remotefilming.com")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Remote Filming Studio - Live video and audio streaming and recording software")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_EXECUTABLES
		"rfs32" "Remote Filming Studio (32bit)"
		"rfs64" "Remote Filming Studio (64bit)")
	...
	set(CPACK_PACKAGE_EXECUTABLES "rfs${_output_suffix}" "Remote Filming Studio")
	set(CPACK_CREATE_DESKTOP_LINKS "rfs${_output_suffix}")
endif()

set(CPACK_BUNDLE_NAME "RemoteFilmingStudio")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "RemoteFilmingStudio")
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-filming-studio-${OBS_VERSION}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	if(WIN32)
		set(CPACK_PACKAGE_NAME "Remote Filming Studio (64bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "RemoteFilmingStudio64")
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-filming-studio-x64-${OBS_VERSION}")
else()
	if(WIN32)
		set(CPACK_PACKAGE_NAME "Remote Filming Studio (32bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "RemoteFilmingStudio32")
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-filming-studio-x86-${OBS_VERSION}")
endif()
