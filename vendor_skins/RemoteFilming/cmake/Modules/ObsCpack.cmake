...
if(INSTALLER_RUN)
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-fliming-${OBS_VERSION}-${GIT_TAG}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-filming-x64-${OBS_VERSION}-${GIT_TAG}")
else()
	if(WIN32)
	...
	set(CPACK_PACKAGE_FILE_NAME "remote-fliming-x86-${OBS_VERSION}-${GIT_TAG}")
endif()
