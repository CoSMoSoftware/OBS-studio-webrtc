...
bundle_dylibs() {
    ...
    ${CI_SCRIPTS}/app/dylibbundler -cd -of -a ./B-CAM.app -q -f \
       ...
       -x ./B-CAM.app/Contents/PlugIns/aja.so \
       -x ./B-CAM.app/Contents/PlugIns/aja-output-ui.so \
...
#       -x ./B-CAM.app/Contents/PlugIns/obs-browser.so \
    ...
    /bin/cp ./libobs-opengl/${BUILD_CONFIG}/libobs-opengl.so ./B-CAM.app/Contents/Frameworks
}
...
prepare_macos_bundle() {
    ...
    /bin/cp -R dSYMs B-CAM.app/Contents/
...
#    /bin/cp -R "rundir/${BUILD_CONFIG}/bin/OBS Helper (Renderer).app" "./B-CAM.app/Contents/Frameworks/OBS Helper (Renderer).app"
    ...
    if [ -d ./B-CAM.app/Contents/Resources/data/obs-scripting ]; then
        ...
        # /bin/mv ./B-CAM.app/Contents/Resources/data/obs-scripting/obspython.py ./B-CAM.app/Contents/Resources/
    ...
    /bin/cp -cpR /tmp/obsdeps/lib/*.dylib ./B-CAM.app/Contents/Frameworks
