...
#        -x ./A-CAM.app/Contents/PlugIns/obs-browser.so \
    ...
    BUNDLE_PLUGINS=(
        ./A-CAM.app/Contents/PlugIns/coreaudio-encoder.so
        ./A-CAM.app/Contents/PlugIns/decklink-ouput-ui.so
        ./A-CAM.app/Contents/PlugIns/decklink-captions.so
        ./A-CAM.app/Contents/PlugIns/frontend-tools.so
        ./A-CAM.app/Contents/PlugIns/image-source.so
        ./A-CAM.app/Contents/PlugIns/mac-avcapture.so
        ./A-CAM.app/Contents/PlugIns/mac-capture.so
        ./A-CAM.app/Contents/PlugIns/mac-decklink.so
        ./A-CAM.app/Contents/PlugIns/mac-syphon.so
        ./A-CAM.app/Contents/PlugIns/mac-vth264.so
        ./A-CAM.app/Contents/PlugIns/mac-virtualcam.so
        ./A-CAM.app/Contents/PlugIns/obs-ffmpeg.so
        ./A-CAM.app/Contents/PlugIns/obs-filters.so
        ./A-CAM.app/Contents/PlugIns/obs-transitions.so
        ./A-CAM.app/Contents/PlugIns/obs-vst.so
        ./A-CAM.app/Contents/PlugIns/rtmp-services.so
        ./A-CAM.app/Contents/MacOS/obs-ffmpeg-mux
        ./A-CAM.app/Contents/MacOS/obslua.so
        ./A-CAM.app/Contents/PlugIns/obs-x264.so
        ./A-CAM.app/Contents/PlugIns/text-freetype2.so
        ./A-CAM.app/Contents/PlugIns/obs-outputs.so
        ./A-CAM.app/Contents/PlugIns/aja.so
        ./A-CAM.app/Contents/PlugIns/aja-output-ui.so
        ./A-CAM.app/Contents/PlugIns/obs-ndi.so
        ./A-CAM.app/Contents/PlugIns/obs-websocket.so
        )
    ...
    "${CI_SCRIPTS}/app/dylibbundler" -cd -of -a ./A-CAM.app -q -f \
        ...
        -x ./A-CAM.app/Contents/PlugIns/obs-browser-page
