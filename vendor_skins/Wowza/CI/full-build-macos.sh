...
bundle_dylibs() {
    ...
    /bin/cp ./libobs-opengl/${BUILD_CONFIG}/libobs-opengl.so "./Wowza-OBS-Real-Time.app/Contents/Frameworks"
}
...
install_frameworks() {
    ...
    step "Copy Framework..."
    /bin/cp -R "${DEPS_BUILD_DIR}/cef_binary_${MACOS_CEF_BUILD_VERSION}_macos_x86_64/Release/Chromium Embedded Framework.framework" "./Wowza-OBS-Real-Time.app/Contents/Frameworks/"
